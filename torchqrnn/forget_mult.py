...
kernel = '''
extern "C"
__global__ void recurrent_forget_multd(double *dst, const double *f, const double *x, int SEQ, int BATCH, int HIDDEN)
{
  /*
...
__global__ void bwd_recurrent_forget_multd(const double *h, const double *f, const double *x, const double *gh, double *gf, double *gx, double *ghinit, int SEQ, int BATCH, int HIDDEN)
{
  /*
  Note: h is assumed to be one timestep longer than f, x, gf, gx, or gh where dst[0] = h_{-1}
  This means dst array has a separate index than that of f or x
